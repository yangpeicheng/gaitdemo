...
TwL.set(H,{transformOrigin:'-5px 0px',rotation:0,fill:'#454545',y:-1});
TwL.set(F,{transformOrigin:'55% 10px',rotation:0,fill:'#DC0026'});
TwL.set('#H',{transformOrigin:'5px 50px',fill:'#454545',scale:0.967,rotation:0});
TwL.set('.H1',{rotation:0,transformOrigin:'0px 5px',y:-5});
TwL.set('.H2',{transformOrigin:'10% 0%',rotation:0,y:-1.5,scaleY:1.03});
